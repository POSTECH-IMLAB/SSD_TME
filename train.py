...
# --resume=weights/ssd300_0712_310000.pth --iterations=500000
...
parser.add_argument('--iterations', default=140000, type=int, help='Number of training iterations')
...
def train():
    ...
    for iteration in range(start_iter, args.iterations + 1):
        ...
        if iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/ssd' + str(args.dim) + '_' + str(args.dataset) + '_' +
                       repr(iteration) + '.pth')
