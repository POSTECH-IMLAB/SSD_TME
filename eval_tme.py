...
# annopath = os.path.join(DataRoot, 'TME_Motorway', 'test', 'labels_xml', '%s.xml')
# imgpath = os.path.join(DataRoot, 'TME_Motorway', 'test', 'images', '%s.jpg')
# imgsetpath = os.path.join(DataRoot, 'TME_Motorway', 'test', '{:s}.txt')
